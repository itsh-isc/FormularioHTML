...
function validarForma(forma) {
    ...
    for (i = 0; i < tecnologias.length; i++) {
        if (tecnologias[i].checked) {
            checkSeleccionado = true; //con uno que haya sido seleccionado es suficiente
        }
    }
    ...
    //si ningun radiobutton se selecciono, se manda el mensaje
    ...
    //debe de estar seleccionada una opcion diferente de la default
    if (ocupacion.value == "") {
